...
<section id="Register" class="about">
      ...
      <div class="col-md-6 offset-md-3">
		...
		%>
		<%
			String flags = (String) request.getAttribute("messag");
			if(flags != null){
				flags = "Your email is already used.";
		...
		<div class="form-floating">
			<input type="password" class="form-control" placeholder="Password"
				name="password" required> <label for="floatingPassword">Create Password</label>
		</div>
		<br>
		...
		<div class="form-floating">
			Already have an account?<a class="nav-link active"
				href="${pageContext.request.contextPath}/login_register?action=navlogin">Sign
				in now</a>
		</div>
